...
// - randomly shuffle pizzas of same length
public class Algorithm7 extends Algorithm {
    protected Algorithm7(Input input) {
        super(input);
    }
    ...
    Output run() {
        ...
        sortedPizzas.sort(Comparator.comparingDouble(o -> o.numIngredients + random.nextDouble()));
